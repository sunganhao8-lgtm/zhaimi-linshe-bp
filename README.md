...
> **核心数据**：启动资金 **23.5 万**（含电竞 1.5 万） · 月固定 **1.57 万** · 回本 **24-32 月** · 客流 1km/6 小区/900 户 · 6 家竞品
...
- 🎨 **[门店布局编辑器](https://sunganhao8-lgtm.github.io/zhaimi-linshe-bp/layout-editor.html)** — 49㎡ (7×7) 可拖拽设计（含 5 个电竞组件：吧台/PS5/Switch/电竞椅/大屏）
...
| 面积 | **49㎡** (7m × 7m) | 实地勘察 |
| 启动资金 | **23.5 万**（转让 9.5w + 房租 4w + 设备 4.2w + 电竞 1.5w + 装修/证照/流动 4.3w） | BP 财务模型 |
